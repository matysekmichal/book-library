        ...
        <div class="container">
            <div class="content">
                ...
                <div class="book-list-grid">
                    ...
                    <div class="action">
                        <a href="/book?r=<?= $book['b_slug'] ?>" class="text-center text-danger">
                ...
                <div class="next-step">
                    ...
                    <span id="dialog-close" class="btn btn-sm btn-square btn-secondary dialog-close">Kontynuj wypożyczanie</span>
                </div>
            </div>
        </div>
    </div>
